...
{
    //tr_info("PalRtcEnableCompareIrq %d", channelId);
    PAL_RTC_CHECK(channelId < RTC_TIMER_TOTAL_CHANNEL);
...
{
    //tr_info("PalRtcDisableCompareIrq %d", channelId);
    PAL_RTC_CHECK(channelId < RTC_TIMER_TOTAL_CHANNEL);
...
{
    //tr_info("PalRtcDisableCompareIrq %d => %u", channelId, value);
    PAL_RTC_CHECK(channelId < RTC_TIMER_TOTAL_CHANNEL);
